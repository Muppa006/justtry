...
const Renderdefectlog = (props) => {
  ...
  var Region = "";
  // console.log(xyz + "top")
  const Mfp = (check, sno, bno) => {
    let checkCondition = check;
    if (checkCondition == 0) {
      setticked(!ticked);
      axios
        .post("/markfalsepositiveto1", { SNO: sno, bottleno: bno })
        .then((res) => {
          setsbd(res.data);
          console.log(sbd);
        });
      ...
      axios
        .post("/markfalsepositiveto0", { SNO: sno, bottleno: bno })
        .then((res) => {
          setsbd(res.data);
        });
      setticked(!ticked);
  ...
  case false:
    ...
    break;
                    ...
                    var imagedate = name.slice(
                      monthindex - 2,
                      monthindex + m.length + 4
                    );
                          ...
                          <div className="image">
                            ...
                            >
                              <img
                                ...
                                src={
                                  process.env.REACT_APP_CLIENT_IMAGES +
                                  "/" +
                                  xyz +
                                  "/" +
                                  Region +

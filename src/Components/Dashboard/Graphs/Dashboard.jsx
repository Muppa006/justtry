...
const removedefect = (option) => {
  ...
  if (option.includes("All")) {
    setCheckedValues((prev) => {
      return { ...prev, Discoloration: true,Scratches: true,"Good Bottle": true,"Foreign Particles": true,"Bottle Cap": true,Dent: true, Others: true };
    });
  ...
  if (option.includes("Dent")) {
    setCheckedValues((prev) => {
      return { ...prev, Dent: true };
    });
  } else {
    setCheckedValues((prev) => {
      return { ...prev, Dent: false };
    });
  }

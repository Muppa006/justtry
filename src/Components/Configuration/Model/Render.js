...
const handletoggle = () => {
  ...
  const handlethresholdvalues = () =>{
    ...
    if (props.itm.Status=="Active"){
      ...
      dispatch(Systemdata({Model:res.data[0].Model,Scratches:res.data[0].Scratches,ForeignParticles:res.data[0].Foreign_Particles,Discoloration:res.data[0].Discoloration,Bottle_Cap:res.data[0].Bottle_Cap,Dents:res.data[0].Dents,Others:res.data[0].Others,Sno:res.data[0].Sl_No})) 

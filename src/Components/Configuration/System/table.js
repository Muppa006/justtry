...
const Table = (props) => {
  ...
  const defecttypes =
  {
    ...
    Discoloration: props.itm.Discoloration,Dent:props.itm.Dent,
  ...
  const handleEdit = () => {
    ...
    let  Den = props.itm.Dent.slice(0,-1)
    let BottleCa = props.itm.Bottle_Cap.slice(0, -1)
    let Other = props.itm.Others.slice(0, -1)

    setstore({
      Scratches: Scratche, ForeignParticles: ForeignParticle, Discoloration: Discoloratio,Dent:Den
  ...
  const handlesave = (e) => {
    if (store.Scratches.length != 0 && store.ForeignParticles.length != 0 && store.Discoloration.length != 0 && store.Bottle_Cap.length != 0 && store.Others.length != 0 && store.Dent.length != 0) {
      if (store.Scratches.length <= 3 && store.ForeignParticles.length <= 3 && store.Discoloration.length <= 3 && store.Bottle_Cap.length <= 3 && store.Others.length <= 3 && store.Dent.length <= 3) {
        // e.preventDefault();
...
{edit ? (store.Dent
  ...
  <>
    ...
    <input
      ...
      max="100"
      min="1"
      defaultValue={store.Dent}
      onChange={(e) => setstore({ ...store, Dent: e.target.value })
      }
    />
